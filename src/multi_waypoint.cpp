...
namespace rviz_multi_waypoint_plugin
{
  ...
  */
  ...
  Line::Line(Ogre::SceneManager* scene_manager, Ogre::SceneNode* scene_node)
    ...
    /*
    Ogre::MaterialPtr m = Ogre::MaterialManager::getSingleton().getByName("rviz/waypoint_line");
    ...
    vertex_data_->begin("rviz/waypoint_line", Ogre::RenderOperation::OT_TRIANGLE_LIST, "rviz");
